...
public class DriveSubsystem extends SubsystemBase {
 ...
 public AHRS m_navx = new AHRS(edu.wpi.first.wpilibj.SPI.Port.kMXP);
 ...
 //odometry setup
  ...
  public double getLMasterEnc() {
    ...
    return (LMaster.getSelectedSensorPosition() / Constants.QUADRATURE_COUNT) * -1;
  ...
  public void arcadeDrive (double fwd, double rot) {
    ...
    DriveTrain.arcadeDrive(rot, fwd);
  }
