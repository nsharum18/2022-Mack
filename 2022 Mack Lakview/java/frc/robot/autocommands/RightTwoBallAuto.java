...
public class RightTwoBallAuto extends SequentialCommandGroup {
    ...
    public RightTwoBallAuto(DriveSubsystem m_drive, ArmSubsystem m_arm, WristSubsystem m_wrist, IntakeSubsystem m_intake, LClimbSubsystem l_climb, RClimbSubsystem r_climb) {
      ...
      Trajectory r2b1 = m_drive.generateTrajectroy(Constants.r2b1);
      Trajectory r2b2 = m_drive.generateTrajectroy(Constants.r2b2);
...
*/
            new InstantCommand(() -> m_drive.resetOdometry(r2b1.getInitialPose())),

           // new ParallelDeadlineGroup(
              new FollowTrajectory(m_drive, r2b1),
              //new IntakePosition(m_arm, m_wrist),
              //new Intake(m_intake)
            //),

            //new ParallelDeadlineGroup(
              new FollowTrajectory(m_drive, r2b2)
