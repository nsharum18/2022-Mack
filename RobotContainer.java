...
public class RobotContainer {
  ...
  //autos
  private final Command LeftTwoBallAuto = new LeftTwoBallAuto(m_drive, m_arm, m_wrist, m_intake, l_climb, r_climb, m_navx);
  private final Command LeftOneBallAuto = new LeftOneBallAuto(m_drive, m_arm, m_wrist, m_intake, l_climb, r_climb, m_navx);
  private final Command RightThreeBallAuto = new RightThreeBallAuto(m_drive, m_arm, m_wrist, m_intake, l_climb, r_climb, m_navx);
  private final Command RightTwoBallAuto = new RightTwoBallAuto(m_drive, m_arm, m_wrist, m_intake, l_climb, r_climb, m_navx);
  private final Command RightOneBallAuto = new RightOneBallAuto(m_drive, m_arm, m_wrist, m_intake, l_climb, r_climb, m_navx);
  private final Command BackOneBallAuto = new BackOneBallAuto(m_drive, m_arm, m_wrist, m_intake, l_climb, r_climb, m_navx);
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(Driver1, XboxConstants.BACK)
        .whenPressed(new resetDriveEnc(m_drive));

    //Driver1 Select Button sets encoders to start config
    new JoystickButton(Driver1, XboxConstants.START)
        .whenPressed(new setStartConfig(m_arm, m_drive, m_intake, m_wrist, l_climb, r_climb, m_navx));
    ...
    .whileHeld(new ArmManualDown(m_arm));
