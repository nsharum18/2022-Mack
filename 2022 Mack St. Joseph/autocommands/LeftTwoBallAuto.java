...
public class LeftTwoBallAuto extends SequentialCommandGroup {
    ...
    public LeftTwoBallAuto(DriveSubsystem m_drive, ArmSubsystem m_arm, WristSubsystem m_wrist, IntakeSubsystem m_intake, LClimbSubsystem l_climb, RClimbSubsystem r_climb, NavXSubsystem m_navx) {
        ...
        //turn to the left
        new TurnCommand(true, Constants.LeftTwoBallAuto.AUTO_LTURN, Constants.AUTO_SPEED, m_drive, m_navx),
        ...
        new DriveIntakeCommand(true, Constants.LeftTwoBallAuto.AUTO_FORWARD1, Constants.AUTO_SPEED * -1, m_drive, m_intake),

        //score position
        new ScorePosition(m_arm, m_wrist),

        //turn to the right
        new TurnCommand(false, Constants.LeftTwoBallAuto.AUTO_RTURN, Constants.AUTO_SPEED * -1, m_drive, m_navx),

        //zeros drive encoders
        new resetDriveEnc(m_drive),

        //drives forward
        new DriveCommand(true, Constants.LeftTwoBallAuto.AUTO_FORWARD2, Constants.AUTO_SPEED * -1, m_drive),
