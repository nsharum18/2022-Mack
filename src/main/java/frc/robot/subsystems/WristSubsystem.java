...
public class WristSubsystem extends SubsystemBase {
  ...
  public void wristSetStartEnc() {
    ...
    wrist.setSelectedSensorPosition(Constants.WRIST_STARTING_CONFIG);
  ...
  public void wristSetIntake() {
    ...
    if (getWristEnc() >= Constants.WRIST_INTAKE_VALUE) {
  ...
  public void wristSetStart() {
    ...
    //sets wrist to start
    if (getWristEnc() <= Constants.WRIST_STARTING_CONFIG) {
