...
public class RightThreeBallAuto extends SequentialCommandGroup {
    ...
    public RightThreeBallAuto(DriveSubsystem m_drive, ArmSubsystem m_arm, WristSubsystem m_wrist, IntakeSubsystem m_intake, LClimbSubsystem l_climb, RClimbSubsystem r_climb, NavXSubsystem m_navx) {
        ...
        //turn to the right
        new TurnCommand(true, Constants.RightThreeBallAuto.AUTO_LTURN1, Constants.AUTO_SPEED, m_drive, m_navx),
        ...
        //turn to the right
        new TurnCommand(true, Constants.RightThreeBallAuto.AUTO_LTURN2, Constants.AUTO_SPEED, m_drive, m_navx),
        ...
        //turn to right
        new TurnCommand(true, Constants.RightThreeBallAuto.AUTO_LTURN3, Constants.AUTO_SPEED, m_drive, m_navx),
