...
public final class Constants {
    ...
    public static final double ARM_INTAKE_VALUE = 6;
    public static final double ARM_STARTING_CONFIG = 119;

    //wrist encoder values
    public static final double WRIST_SCORE_VALUE = 58;
    public static final double WRIST_INTAKE_VALUE = 5;
    public static final double WRIST_STARTING_CONFIG = 142;
    public static final double WRIST_DOWN_VALUE = 74;
    ...
    public static final double HIGH_SPEED = .7;

    //climb values
    public static final double LEXTEND_HEIGHT = 130;
    public static final double REXTEND_HEIGHT = 130;
    ...
    public static final double BACK_DISTANCE = -30;
